      ...
      <div className='modal-box'>
        ...
        <form className='modal-form' onSubmit={handleSubmit}>
          <div className='form-grid'>
            ...
            <div className='form-field'><label className='field-label'>Land Size (acres) *</label><input type='number' step='0.1' min='0' value={form.land_size} onChange={e => set('land_size', e.target.value)} placeholder='e.g. 2.5 (0 if none)' /></div>
